package com.agenda.web.rest;

import com.agenda.service.ContactService;
import com.agenda.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.agenda.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
public class ContactResource {
    ...
    private static final String ENTITY_NAME = "agendaContact";
